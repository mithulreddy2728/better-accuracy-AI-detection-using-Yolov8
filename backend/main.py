...
# CORS middleware – read origins from environment variable for flexibility
# Defaults cover both local dev and Docker (nginx on port 80)
_cors_env = os.getenv("CORS_ORIGINS", "http://localhost:3000,http://localhost,http://localhost:80")
